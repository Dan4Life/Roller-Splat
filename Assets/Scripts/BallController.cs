...
public class BallController : MonoBehaviour
{
    ...
    private Vector2 swipePosCurFrame;
    ...
    private void FixedUpdate()
    {
        ...
        {
            swipePosCurFrame = new Vector2(Input.mousePosition.x, Input.mousePosition.y);

            if(swipePosLastFrame != Vector2.zero)
            {
                currentSwipe = swipePosCurFrame - swipePosLastFrame;
            ...
            swipePosLastFrame = swipePosCurFrame;
        }
